  ...
  return (
    <section className="bg-[#e0f7f1] py-20 font-sans">
      <div className="max-w-6xl mx-auto px-6">
        {/* Header */}
        <h2 className="text-4xl font-serif text-[#064e3b] font-bold mb-4">
          Amenities
        </h2>
        ...
        <div className="mt-24">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {buildings.map((b, i) => (
              <div
                key={i}
                className="rounded-[40px] overflow-hidden shadow-lg relative aspect-[3/4] group cursor-pointer bg-white"
              >
                <img
                  src={b.image}
                  alt={b.name}
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-6 pt-20">
                  <div
                    className={`px-4 py-2 rounded-lg text-center backdrop-blur-sm border border-white/20 shadow-lg ${
                      b.status.includes('Newly')
                        ? 'bg-[#bbf7d0]/90 text-brand-dark'
